...
router.post("/employees/:id/verify-update", verifyDepartmentAccess, hrController.verifyEmployeeProfileUpdate);
...
router.post("/recruitment/candidates/:id/convert-to-employee", hrController.convertCandidateToEmployee);
